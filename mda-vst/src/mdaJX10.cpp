...
void mdaJX10::update()  //parameter change
{
    ...
    if (param[10] < 0.05f) { veloff = 1; filtvel = 0; }
    else veloff = 0;
...
bool  mdaJX10::getEffectName(char* name) { strcpy(name, "mda JX10"); return true; }
...
void mdaJX10::getParameterDisplay(VstInt32 index, char* text)
{
    ...
    default: strcpy(string, "M-GLIDE "); break;
    } break;
